  ...
  return (
    <>
      ...
      <div className="flex flex-col justify-start min-h-screen font-generalSansRegular text-[#009DC8]">
        <nav className="bg-white text-black px-4 py-5 font-generalSansMedium border-b-2 border-b-black">
          <div className="flex justify-between items-center max-w-8xl mx-auto">
            <img
              src="logo.png"
              className="max-w-[120px] md:justify-start justify-items-center drop-shadow-xl hover:scale-110 transition-transform"
            />
          </div>
        </nav>

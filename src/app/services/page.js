        ...
        <>
            ...
            <div className="min-h-screen bg-[#f5f5f5] px-10 py-5 flex flex-col items-center">
                <div className="bg-white px-10 py-5 w-full max-w-7xl rounded-lg shadow-lg mt-8">
                    <div className="text-left text-xl py-5 font-extrabold tracking-wider uppercase text-gray-900">Services</div>
                    ...
                    {/* Dropdown Filters */}
                    <div className="w-full max-w-6xl flex flex-wrap justify-center gap-3 px-6 mt-6">
                        <DropdownESG
                            label="ESG Category"
                            ...
                            <div className="flex flex-col items-center">
                                ...
                                <div className="flex flex-wrap gap-1 text-gray-700 text-xs sm:text-sm justify-center mt-2">
                                    {Array.isArray(items.tags) ? items.tags.map((tag, i) => (
                                        <span key={i} className="bg-white-200 px-2 py-1 rounded-md">{tag}</span>
                                    )) : null}
                                </div>
                            </div>
                            <button onClick={() => { }}
    ...
    return (
        <Listbox value={selected} onChange={setSelected} multiple>
            <div className="relative">
                <Listbox.Button className="flex text-gray-900 font-bold bg-[#f5f5f5] border rounded-md w-80 py-1 hover:shadow-lg">
                    {label}
                </Listbox.Button>
                <Transition
